...
boxfig = sns.boxplot(x=filtered_data['Age'], y=filtered_data['Name'], data=filtered_data, orient="h",)
boxfig.figure

viofig = sns.violinplot(x=filtered_data['Height'],  y=filtered_data['Name'], data=filtered_data, orient="h")
viofig.figure

swarmfig = sns.swarmplot(x=filtered_data['Weight'], y=filtered_data['Name'], data=filtered_data, orient="h")
swarmfig.figure